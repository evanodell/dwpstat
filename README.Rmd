...
[![AppVeyor build status](https://ci.appveyor.com/api/projects/status/github/evanodell/dwpstat?branch=master&svg=true)](https://ci.appveyor.com/project/evanodell/dwpstat)
